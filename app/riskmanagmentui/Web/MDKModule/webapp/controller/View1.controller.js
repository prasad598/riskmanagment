sap.ui.define([
	...
	return Controller.extend("riskmanagement_riskmanagmentui.controller.View1", {
        setUrl: function () {
            ...
            var url = sap.ui.require.toUrl("riskmanagement_riskmanagmentui/mdkindex.html?" + queryString);
